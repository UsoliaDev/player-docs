...
自 2020 年 2 月 — Usolia Java 版服务器开启之时起，已有超过 2000 名玩家登录服务器创造了数十GB的存档增量并留下了无数的故事。

---

## *温暖和谐的玩家社区 / 独具一格的游戏玩法 / 可持续性的运营策略*
...
- [进入服务器](https://docs.usolia.net/#/)
- 加入服务器 QQ 群：641358246
- 浏览服务器官网与论坛：[usolia.net](https://usolia.net)
- 了解[数据处理政策](https://policies.usolia.net/#/docs/ot/privacy)
- 阅该读介绍的另一版本个
